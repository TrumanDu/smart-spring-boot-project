...
public class Assert {
    ...
    public static void isTrue(boolean expression, String message, String code) throws BusinessException {
        isTrue(expression, () -> new BusinessException(Integer.parseInt(code), message));
    }
    ...
    public static void isFalse(boolean expression, String message, String code) throws BusinessException {
        isFalse(expression, () -> new BusinessException(Integer.parseInt(code), message));
    }

    public static void isFalse(boolean expression, ResultCodeEnum resultEnum) throws BusinessException {
    ...
    public static void isNull(Object object, String message, String code) throws BusinessException {
        isNull(object, () -> new BusinessException(Integer.parseInt(code), message));
    }

    public static void isNull(Object object, ResultCodeEnum resultEnum) throws BusinessException {
    ...
    public static <T> T notNull(T object, String message, String code) throws BusinessException {
        return notNull(object, () -> new BusinessException(Integer.parseInt(code), message));
    }

    public static <T> T notNull(T object, ResultCodeEnum resultEnum) throws BusinessException {
     ...
     * @throws BusinessException if the object is {@code null}
     */
    public static <T> void notNull(T object) throws BusinessException {
